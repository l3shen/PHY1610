...
int main(int argc, char* argv[])
{
    ...
    for (int s = 0; s < nsteps; s++) {
        ...
        // Evolve
	// This is the first step, parallelizing the time evolution for loop.
	#pragma omp parallel for default(none) shared(tau,ngrid,c,dx,rho,rho_prev,rho_next,dt) // Include all necessary variables as shared.
